...
import { AG_GRID_LOCALE_ES, paginationPageSizeSelector, columnDefsDocExit, frameworkComponents, useTableHandlers } from '../utils/tableConfig';

const DocumentEntry = React.memo(() => {
  const { data, isLoading, error } = useFetch('http://localhost/cdoc-app/api/documents/all/3');
